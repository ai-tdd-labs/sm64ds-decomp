...
|---|---|---|---|
| arm9 func_0201b388 (0x0201b388, size 0x220; API clm_d5a626dcd28a) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — round 33 bounded refinement; source absent on origin/main ec5566d8; DB div=8; strict oracle + linkcheck required |
| ov062 func_ov062_02117724 (0x02117724, size 0x270; API clm_2dd072c10cb7) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — round 33 bounded refinement; source absent on origin/main ec5566d8; DB div=7; strict oracle + linkcheck required |
| ov006 func_ov006_020f4cd8 (0x020f4cd8, size 0x2bc; API clm_5cf0e71b2c2f) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — round 33 bounded refinement; source absent on origin/main ec5566d8; DB div=6; strict oracle + linkcheck required |
...
| ov002 _ZN5Enemy22SpawnMegaCharParticlesER5ActorPc (0x020adb40, size 0x280; API clm_d5d6951acd17) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | released — parked after 10 variants / 556 s at strict div=3; first Actor-vector access materialization wall; existing DB best retained |
...
| ov006 func_ov006_020e8f14 (0x020e8f14, size 0x28c; API clm_b0d899a1a7d4) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 8 material variants / ~440 s; strict MATCH + linkcheck VERIFIED blind=0; PR #448 open |
...
| ov007 func_ov007_020c8498 (0x020c8498, size 0x1f0; API clm_65b8d96fd316) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 2 control-flow variants / 276 s; strict MATCH + linkcheck VERIFIED blind=0; PR #446 open |
| ov007 func_ov007_020c8de0 (0x020c8de0, size 0x178; API clm_c41061e03605) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 5 interpolation variants / 681 s; strict MATCH + linkcheck VERIFIED blind=0; PR #447 open |
| ov006 func_ov006_0211134c (0x0211134c, size 0x214; API clm_bcfc44e25a5b) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 1 opt_propagation variant; strict MATCH + linkcheck VERIFIED blind=0; PR #446 open |
| ov100 func_ov100_02146e70 (0x02146e70, size 0x19c; API clm_9db4c22ec7ef) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 1 targeted C89-local-order variant / 150 s; strict MATCH + linkcheck VERIFIED blind=0; PR #446 open |
...
| ov006 func_ov006_021231ac (0x021231ac, size 0x194; API clm_06ab51d4688c) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 2 variants / ~177 s; strict MATCH + linkcheck VERIFIED blind=0; PR #446 open |
...
| ov002 func_ov002_020d6368 (0x020d6368, size 0x10c; API clm_fb85fcf4417c) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 4 variants / ~5 min; strict MATCH + linkcheck VERIFIED blind=0; PR #445 open |
| ov002 func_ov002_020c0fb4 (0x020c0fb4, size 0x280; API clm_af147b560624) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 4 variants / ~286 s; strict MATCH + linkcheck VERIFIED blind=0; PR #445 open |
...
| ov002 func_ov002_020af4ec (0x020af4ec, size 0x198; API clm_cb8b15e1587a) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | active — exact after 3 variants / ~320 s; strict MATCH + linkcheck VERIFIED blind=0; PR #445 open |
...
| ov006 func_ov006_020e5b7c (0x020e5b7c, size 0x2c0; API clm_33e9b897eb78) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | done/released — PR #429 merged; exact 704 bytes, strict + linkcheck VERIFIED blind=0 |
...
| ov063 func_ov063_0211a3d0 (0x0211a3d0, size 0x194; API clm_9f350ebbaed7) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | released — parked at seven-word r2/r3 coloring wall after fixing stack order; no src change |
...
| ov075 func_ov075_02118d1c (0x02118d1c, size 0x21c; API clm_f8e4ec33b745) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-17 | done/released — PR #427 merged; exact 540 bytes, strict + linkcheck VERIFIED blind=0 |
...
| ov006 func_ov006_020eb3e4 (0x020eb3e4, size 0x174; API clm_231921c9d027) | ai-tdd-labs (Codex Sol 5.6 high) | 2026-07-16 | done — exact 372 bytes, strict + linkcheck VERIFIED; PR #396 merged, API lock released |
