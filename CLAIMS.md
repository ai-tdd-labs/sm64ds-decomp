...
| easy/spread fan-out (36 funcs, size ~0x70-0x1fc): arm9(4), ov002(5), ov004(1), ov006(6), ov007(11), ov030(1), ov060(3), ov063(1), ov074(1), ov095(1), ov100(1), ov102(1) | andrew (Claude-assisted) | 2026-07-16 | done — 9/36 matched byte-identical, PR #350 merged; 27 near-miss walls documented (register-coloring/scheduling), drafts in scratch only |
| easy/spread fan-out run 2 (36 funcs, size ~0x5c-0x1fc): arm9(21), ov002(4), ov006(11) | andrew (Claude-assisted) | 2026-07-16 | in progress — worklist --easy --spread next-of-pile picks, filtered against rebuilt ledger + live belongto.us claims + run-1's 27 near-miss names (no key, coordinating via this row) |
