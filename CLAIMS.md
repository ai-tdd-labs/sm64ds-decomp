...
| easy/spread fan-out (36 funcs, size ~0x70-0x1fc): arm9(4), ov002(5), ov004(1), ov006(6), ov007(11), ov030(1), ov060(3), ov063(1), ov074(1), ov095(1), ov100(1), ov102(1) | andrew (Claude-assisted) | 2026-07-16 | done — 9/36 matched byte-identical, PR #350 merged; 27 near-miss walls banked to nearmiss/db.jsonl (PR #354) |
| easy/spread fan-out run 2 (36 funcs, size ~0x5c-0x1fc): arm9(21), ov002(4), ov006(11) | andrew (Claude-assisted) | 2026-07-16 | done — 3/36 matched byte-identical, PR #353 open; 33 near-miss walls banked to nearmiss/db.jsonl (PR #354) |
| broad (non-easy, <=0x200) fan-out run 3 (36 funcs): arm9(4), ov002(4), ov004(1), ov007(6), ov014(1), ov060(3), ov063(2), ov065(4), ov075(2), ov079(1), ov084(2), ov085(1), ov095(2), ov100(2), ov102(1) | andrew (Claude-assisted) | 2026-07-16 | in progress — --easy pile exhausted after runs 1/2, pulled from broader pile; filtered against rebuilt ledger + live belongto.us claims + all run1/2 near-miss names (no key, coordinating via this row) |
